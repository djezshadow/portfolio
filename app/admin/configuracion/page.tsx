    ...
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <HeroSettingsForm
        ...
        initial={{
          ...
          heroTitle1En: settings.heroTitle1En,
          ...
          homeAlign: settings.homeAlign,
          carouselItemSize: settings.carouselItemSize,
          carouselGap: settings.carouselGap,
